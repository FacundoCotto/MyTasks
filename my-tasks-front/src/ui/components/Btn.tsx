...
export function Btn({
  ...
  const variants: Record<string, string> = {
    ...
    auth_active: "bg-violet-600 text-white px-10 py-3 rounded-full font-semibold transform hover:scale-105 transition-transform duration-300 cursor-pointer md:flex italic shadow-lg shadow-violet-500/30 hover:bg-violet-700",
    auth_inactive: "bg-white text-slate-500 border border-slate-200 hover:bg-slate-50 px-10 py-3 rounded-full font-semibold transform hover:scale-105 transition-all duration-300 cursor-pointer md:flex italic",
